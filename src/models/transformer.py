...
from .CCT import CCTransformer, CCAttention, Mlp, _init_weights
...
class DecoderLayer(nn.Module):
    def __init__(self,
        ...
        # self.multihead_attn = MultiHeadAttention(self.dim, nhead)
    ...
    def forward(self,
        ...
        tgt = tgt + self.mlp(self.norm3(tgt), 1, 1)
...
class QueryTransformer(nn.Module):
    def __init__(self,
        ...
        self.cct_encoder = CCTransformer(
            feat_size=cfg.FEAT_SIZE,
            feat_chan=cfg.FEAT_CHAN,
            depths=cfg.DEPTH,
            num_heads=cfg.NUM_HEADS,
            msa_sizes=cfg.MSA_SIZES,
            no_ker_sizes=cfg.NON_OVERLAP_SIZES
        )

        self.cca_decoder = TransformerDecoder(
            d_model=d_model,
            nhead=nhead,
            feat_size=cfg.FEAT_SIZE,
            no_ker_size=cfg.NON_OVERLAP_SIZES[0],
            num_layers=2
        )
    ...
    def forward(
        ...
        feat0, feat1 = self.cct_encoder(feat0, feat1)
