...
class CCOE(BaseModel):
    default_conf = {
        ...
        # 'weights': 'scode.pth',
        # 'weights': 'scode_1024.pth',
        # 'weights': 'scode_1024_pt2.pth',
    ...
    def _init(self, conf, model_path):
        ...
        self.net = build_detectors(self.cfg.CCOE).to('cuda:0')
        model_file = model_path / self.conf['weights']
        self.net.load_state_dict(torch.load(model_file, map_location='cuda:0'))
