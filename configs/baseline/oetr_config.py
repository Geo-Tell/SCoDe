...
# cfg.DATASET.TRAIN.LIST_PATH = 'dataset/megadepth/assets/MegaDepth_from_depth_train_V2.txt'
cfg.DATASET.TRAIN.LIST_PATH = 'dataset/megadepth/assets/MegaDepth_from_scale_train.txt'
cfg.DATASET.TRAIN.PAIRS_LENGTH = 128000
# cfg.DATASET.TRAIN.PAIRS_LENGTH = 32000
...
# cfg.DATASET.VAL.LIST_PATH = 'dataset/megadepth/assets/MegaDepth_from_depth_valid_V2.txt'
cfg.DATASET.VAL.LIST_PATH = 'dataset/megadepth/assets/MegaDepth_from_scale_valid.txt'
